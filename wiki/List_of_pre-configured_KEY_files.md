...
* [Create account](/w/index.php?title=Special:CreateAccount&returnto=List+of+pre-configured+KEY+files "You are encouraged to create an account and log in; however, it is not mandatory")
* [Log in](/w/index.php?title=Special:UserLogin&returnto=List+of+pre-configured+KEY+files "You are encouraged to log in; however, it is not mandatory [o]")
...
![](https://wiki.funkey-project.com/wiki/Special:CentralAutoLogin/start?type=1x1) Retrieved from "[https://wiki.funkey-project.com/w/index.php?title=List_of_pre-configured_KEY_files&oldid=22424](https://wiki.funkey-project.com/w/index.php?title=List_of_pre-configured_KEY_files&oldid=22424) "Cookies help us deliver our services. By using our services, you agree to our use of cookies.
...
* [Get shortened URL](/w/index.php?title=Special:UrlShortener&url=https%3A%2F%2Fwiki.funkey-project.com%2Fwiki%2FList_of_pre-configured_KEY_files)
* [Cite this page](/w/index.php?title=Special:CiteThisPage&page=List_of_pre-configured_KEY_files&id=22424&wpFormIdentifier=titleform "Information on how to cite this page")
...
* [What links here](/wiki/Special:WhatLinksHere/List_of_pre-configured_KEY_files "A list of all wiki pages that link here [j]")
* [Related changes](/wiki/Special:RecentChangesLinked/List_of_pre-configured_KEY_files "Recent changes in pages linked from this page [k]")
* [Printable version](javascript:print(); "Printable version of this page [p]")
* [Permanent link](/w/index.php?title=List_of_pre-configured_KEY_files&oldid=22424 "Permanent link to this revision of the page")
* [Page information](/w/index.php?title=List_of_pre-configured_KEY_files&action=info "More information about this page")
* [Page logs](/w/index.php?title=Special:Log&page=List+of+pre-configured+KEY+files)
